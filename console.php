  ...
  <main class="main">
    ...
    <section>
      <div class="main-carousel">
        <div class="cell"><img src="Menu Img/mix-9.jpg" alt="">
          <h5>Digico Sd11</h5>
        ...
        <div class="cell"> <img src="./Menu Img/mix-8 sd 7.webp" alt="">
          <h5>Digico Sd7</h5>
        ...
        <div class="cell"> <img src="./Menu Img/mix-4.jpg" alt="">
          <h5>Digico Sd 10 On Live</h5>
        ...
        <div class="cell"><img src="Menu Img/mix-5.webp" alt="">
          <h5>Digico Quantum225</h5>
        ...
        <div class="cell"><img src="Menu Img/mix-6 sd 5.jpg" alt="">
          <h5>Digico Sd7 Series</h5>
          <p>Working with Mediaglitz has been a pleasure from the very start. He is a very talented sound technician,
        </div>
        <div class="cell"><img src="Menu Img/mix-2.jpg" alt="">
          <h5>Digico Quantum 5</h5>
        ...
        <div class="cell"><img src="./all images/official s-3.jpg" alt="">
          <h5>Little Console</h5>
          <p>Once used mainly for television and film lighting, LED pixel tube lights have taken the event planning industry by storm not only because of their unique look but also because they’re so easy to use and implement.</p>
        </div>
        <div class="cell"><img src="Menu Img/mix - 1.jpg" alt="">
          <h5>Digico Sd8</h5>
