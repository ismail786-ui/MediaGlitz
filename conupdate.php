...
if (isset($_POST['update'])) {
  ...
  $id = $_GET['update'];
  $sql = "update contact set `fname`='$fname',`lname`='$lname',`email`='$email',`mobile`='$mobile',`message`='$message' where id = '$id'";
  if ($conn->query($sql)) {
  ...
  <main>
    ...
    <div class="container">
      <form method="post" >
        ...
        <input type="text" id="firstName" name="fname" placeholder="First Name" required value ="<?php echo $row['fname']?>">
        <input type="text" id="lastName" name="lname" placeholder="Last Name" required value = "<?php echo $row['lname'] ?>">
        <input type="email" id="email" name="email" placeholder="Email" required value = "<?php echo $row['email'] ?>">
        <input type="tel" id="mobile" name="mobile" placeholder="Mobile" maxlength="10" required value = "<?php echo $row['mobile'] ?>">
        <textarea name="message" id="message"  placeholder="Message" required value = "<?php echo $row['message'] ?>"></textarea>
