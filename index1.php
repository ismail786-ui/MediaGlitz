...
<body>
  ...
  <!--------------------------------------Page Center Start------------------------------------------------------------------------------------------------------------------>
  <!-- main section -->
  <section class="center" style="background-image: url(./frontpic/DSC08189-scaled.webp);">
    <div class="container container d-flex-items-center justify-content-center fs-1 text-white flex-column">
      <div class="row">
        <div class="col">
          <b>MediaGlitz</b>
          <p>Audio-Visuals</p>
        ...
        <div class="col">
          <div class="card card1">
            <a href="./sound.php" id="card-a">Sounds</a>
          </div>
          <div class="card card2">
            <a href="./light.php" id="card-a">Lights</a>
          </div>
          <div class="card card3">
            <a href="./ledwall.php" id="card-a">LedWall</a>
          </div>
          <div class="card card4">
            <a href="./sound.php" id="card-a">Roofing</a>
          </div>
        </div>
      </div>
  </section>
  ...
  <style type="text/css">
    ...
    .card {
      ...
      cursor: pointer;
      margin: 10px 15px;
      /* background-image: url(./Z3A3850-scaled.webp); */
    ...
    .card1 {
      background-image: url(./mix-4.jpg);
    }

    .card2 {
      background-image: url(./mediapro\ light\ product.webp);
    }

    .card3 {
      background-image: url(Desktop.ebb65632.creamfields_hardwell_roe_visual_led.jpg);
    }

    .card4 {
      background-image: url(./main\ light\ banner\ -2.jpg);
    }
