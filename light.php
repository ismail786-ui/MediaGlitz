...
<head>
  ...
  <!-- css movhead external -->
  <link href="./css/movhead.css" rel="stylesheet">
  <!-- ionicons link -->
...
<body>
  ...
  <main class="main">
    <nav class="innav">
      <a href="./movhead.php">Moving Head</a>
      <a href="./movwash.php">Moving Wash</a>
      <a href="./laser.php">Lasers</a>
    </nav>
    <main>
      <div class="main-carousel">
        <div class="cell"><img src="./all images/Karen-Zoid-mediapro2-.webp" alt="">
          <h5>Jairam- Partner, Oranjuice Entertainment (at delhi, Feb 2020)</h4>
        ...
        <div class="cell"> <img src="./all images/main light banner -2.jpg" alt="">
          <h5>Light Designs</h4>
        ...
        <div class="cell"> <img src="./all images/djji-dj.jpg" alt="">
        ...
        <div class="cell"><img src="./all images/Gallery – PP 6.jpg" alt="">
        ...
        <div class="cell"><img src="./all images/concert p.jpg" alt="">
        ...
        <div class="cell"><img src="./all images/light pi.jpg" alt="">
        ...
        <div class="cell"><img src="./all images/light laser.jpg" alt="">
          <h5>Jehan Sataravala- CEO, Jaws Events(at Andhra, Jan 2023)</h5>
          <p>Once used mainly for television and film lighting, LED pixel tube lights have taken the event planning industry by storm not only because of their unique look but also because they’re so easy to use and implement.</p>
        </div>
        <div class="cell"><img src="./all images/big concert.jpg" alt="">
