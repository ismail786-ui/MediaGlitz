  ...
  <main class="main">
    ...
    <section>
      <div class="main-carousel">
        <div class="cell"><img src="./Menu Img/mic-2.webp" alt="">
          <h5>Shure Sldx Series</h5>
        ...
        <div class="cell"> <img src="Menu Img/mic-12.jpg" alt="">
          <h5>Shure Axient Double</h5>
        ...
        <div class="cell"> <img src="Menu Img/mic-4.webp" alt="">
          <h5>Mini Rack</h5>
        ...
        <div class="cell"><img src="./Menu Img/mic-9.jpeg" alt="">
          <h5>Backpack Mics</h5>
        ...
        <div class="cell"><img src="Menu Img/mic-6.jpg" alt="">
          <h5>New Inventory</h5>
          <p>Working with Mediaglitz has been a pleasure from the very start. He is a very talented sound technician,
        </div>
        <div class="cell"><img src="Menu Img/mic-7.jpg" alt="">
          <h5>Shure Axient Four</h5>
        ...
        <div class="cell"><img src="./Menu Img/mic-8.jpg" alt="">
          <h5>Loading Shure</h5>
          <p>Once used mainly for television and film lighting, LED pixel tube lights have taken the event planning industry by storm not only because of their unique look but also because they’re so easy to use and implement.</p>
        </div>
        <div class="cell"><img src="Menu Img/mic-11.jpg" alt="">
          <h5>Single Channel Shure</h5>
