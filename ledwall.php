...
<head>
  ...
  <title>MediaGlitz Ledwall</title>
  <!-- bootstarp css link -->
  ...
  <!-- css external link -->
  <link href="./css/ledwall.css" rel="stylesheet">
  <!-- font awesome -->
...
<body>
  ...
  <section>
    <div class="main-carousel">
      <div class="cell"><img src="./all images/led wall media - 2.jpg" alt="">
        <h5>Trade Show</h5>
      ...
      <div class="cell"> <img src="./all images/media a launch.jpg" alt="">
        <h5>Audio Launch</h5>
      ...
      <div class="cell"><img src="./all images/media-proof 4.jpg" alt="">
        <h5>Conference Led Screen</h5>
      ...
      <div class="cell"><img src="./all images/mediapro-1.webp" alt="">
        <h5>Launching</h5>
        <p>Working with Mediaglitz has been a pleasure from the very start. He is a very talented sound technician,
      </div>
      <div class="cell"><img src="./all images/ledwall pp -1.jpg" alt="">
        <h5>Mini Screen</h5>
      ...
      <div class="cell"><img src="./css/images/backline-banner-8.jpg" alt="">
        <h5>BackLine Screen</h5>
        <p>Once used mainly for television and film lighting, LED pixel tube lights have taken the event planning industry by storm not only because of their unique look but also because they’re so easy to use and implement.</p>
      </div>
      <div class="cell"><img src="./css/images/MDL-Xp-mediapro7-scaled.webp" alt="">
        <h5>Indoor Event</h5>
