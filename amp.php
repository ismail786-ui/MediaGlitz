  ...
  <main class="main">
    ...
    <section>
      <div class="main-carousel">
        <div class="cell"><img src="./all images/crown 4.jpg" alt="">
          <h5>Crown Amplification</h4>
        ...
        <div class="cell"> <img src="./Menu Img/Amp - 1.jpeg" alt="">
          <h5>Amplifier Rack</h4>
        ...
        <div class="cell"> <img src="./Menu Img/amp-10.jpg" alt="">
          <h5>I-Tech 12000</h4>
        ...
        <div class="cell"><img src="./Menu Img/amp-11.jpg" alt="">
          <h5>I-Tech 3500*4</h5>
        ...
        <div class="cell"><img src="./Menu Img/amp-9.JPG" alt="">
          <h5>Rock on Crown Rack</h5>
          <p>Once used mainly for television and film lighting, LED pixel tube lights have taken the event planning industry by storm not only because of their unique look but also because they’re so easy to use and implement.</p>
        </div>
        <div class="cell"><img src="./Menu Img/crown itech - 1.png" alt="">
          <h5>Crown Inventory</h5>
